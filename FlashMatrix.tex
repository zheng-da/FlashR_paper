...
R code in parallel and out of core automatically. It provides a small number
of generalized matrix operations (GenOps) and reimplements a large
...
execution while significantly outperforming the in-memory implementations
in Spark MLlib.
\end{abstract}
