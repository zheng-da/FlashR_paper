...
automatically in parallel and out of core. It provides a small number
...
the performance of FlashR. On a large parallel machine, out-of-core execution
of these R implementations in FlashR has performance comparable to the in-memory
