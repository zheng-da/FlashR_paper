...
\title{FlashMatrix: Out-of-Core, Parallel Statistics and Machine Learning through Asynchronous, Fast I/O}
...
FlashMatrix gives machine-learning and statistics routines written in R
access to I/0 and memory-optimized, parallel matrix operations. 
%so that 
...
%
%
FlashMatrix scales matrix operations
...
This allows FlashMatrix to execute R code in parallel and out-of-core automatically.
...
Their execution in FlashMatrix has performance comparable to optimized C implementations.
%When scaling beyond memory capacity on a large parallel machine, 
Out-of-core execution has little overhead when compared with the in-memory exection of FlashMatrix
...
Spark MLlib by a factor of 3 to 30.
\end{abstract}
