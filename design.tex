...
to such a matrix as a \textit{block matrix} and an individual TAS matrix as
a \textit{block}. We choose a small block size so that an Pcache-partition
(Section \ref{sec:datamove}) can fit in CPU L1/L2 cache. Each of the TAS
