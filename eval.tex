...
\begin{figure}
	...
	\begin{subfigure}{.5\textwidth}
		\include{FlashMatrix_figs/FM.vs.spark}
		\label{perf:rt}
		\vspace{-15pt}
		\caption{Runtime}
	\end{subfigure}
	...
	%\vspace{-5pt}
	\begin{subfigure}{.5\textwidth}
		\include{FlashMatrix_figs/FM.vs.spark.mem}
		\label{perf:mem}
		\vspace{-15pt}
...
\begin{figure}
	\begin{center}
		\footnotesize
		\vspace{-15pt}
		\include{FlashMatrix_figs/FM.vs.R}
		\vspace{-10pt}
...
\begin{figure}
	\begin{center}
		\footnotesize
		\vspace{-15pt}
		\include{FlashMatrix_figs/speedup}
		\vspace{-10pt}
...
\begin{figure}
	\begin{center}
		\footnotesize
		\vspace{-15pt}
		\include{FlashMatrix_figs/IM.vs.EM.stat}
		\vspace{-10pt}
...
\begin{figure}
	\begin{center}
		\footnotesize
		\vspace{-15pt}
		\include{FlashMatrix_figs/IM.vs.EM.clust}
		\vspace{-10pt}
		\caption{The relative performance of FlashMatrix on SSDs for
...
the applications when FlashMatrix runs on SSDs (Figure \ref{perf:opts} (a)).
...
of most of the applications when FlashMatrix runs in memory (Figure
\ref{perf:opts} (b)). Operation fusion in CPU cache has performance improvement
on all applications because reducing data movement between main memory and CPU
...
in the applications. Both of the optimizations are more effective for
the applications such as statistical summary and k-means, which require to
...
\begin{figure}
	...
	\vspace{-15pt}
	\begin{subfigure}{.5\textwidth}
		\include{FlashMatrix_figs/opts.EM}
		\label{perf:em_opts}
		\vspace{-15pt}
		\caption{on SSDs}
	\end{subfigure}
	...
	%\vspace{-5pt}
	\begin{subfigure}{.5\textwidth}
		\include{FlashMatrix_figs/opts.IM}
		\label{perf:im_opts}
		\vspace{-15pt}
		\caption{in memory}
	\end{subfigure}
...
VUDFs improve the performance of the applications that rely on GenOps
...
\begin{figure}
	\begin{center}
		\footnotesize
		\vspace{-15pt}
		\include{FlashMatrix_figs/opts.CPU}
		\vspace{-10pt}
