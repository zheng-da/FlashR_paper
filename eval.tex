...
The R framework provides C implementations for correlation, SVD and KMeans.
...
\begin{figure}
	\begin{center}
		...
		\include{scale}
		\vspace{-10pt}
		\caption{The scalability and performance of KMeans in different
		frameworks.}
		\label{fig:scale}
	\end{center}
\end{figure}
...
and KMeans solely rely on GenOps. Therefore, their performance is almost doubled
