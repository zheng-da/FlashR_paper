...
FlashR performs memory hierarchy aware execution to further speed up
parallelized R code by
...
in FlashR outperforms the in-memory execution of H$_2$O and Spark
MLlib by a factor of $3-20$.
\end{abstract}
