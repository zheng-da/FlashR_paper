...
capacity by utilizing solid-state drives (SSDs) automatically. It reimplements
a large number of matrix functions in the R \textit{base} package with a small
number of generalized operations (GenOps). As such,
...
performing two levels of matrix partitioning and reordering computation on
matrix partitions to reduce data movement in the memory hierarchy.
