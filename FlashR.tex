...
as many matrix operations as possible in a single execution, and uses
cache-aware, two-level matrix partitioning.
We evaluate FlashR on a variety of machine learning and statistics algorithms 
on inputs of up to four billion data points. \hl{Despite the huge performance
