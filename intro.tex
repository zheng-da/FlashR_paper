...
over the past decades \cite{Wilkes01}. \dz{NUMA memory}.
...
To minimize data movement, FlashMatrix evaluates expressions lazily and fuses
...
%FlashMatrix determines data placement of matrices based on their shapes.
%In general, a 
%formalization of data placement in FlashMatrix. Can this be considered as
