...
FlashMatrix focuses on optimizations in a single machine (with multiple
...
FlashMatrix is suitable for executing the local part of a distributed 
computation.   
...
achieves performance comparable to in-memory execution,
